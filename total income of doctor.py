...
# for different groups of patients depending on their age. If the patient’s age is below 17, fees is 200 INR.
# If the patient’s age is between 17 and 40, fees is 400 INR. If patient’s age is above 40, fees is 300 INR.
...
def doctor_income(arr):
    income=0
    for i in arr:
        fee= 200 if i<17 else 400 if i<40 else 300
        income+=fee
    print(income)


doctor_income([20,30,40,50,2,3,14])
